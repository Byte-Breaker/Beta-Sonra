...
const ProductDetail: React.FC = () => {
  ...
  const handleBuyNowClick = () => {
    ...
    const message = encodeURIComponent(
      language === 'tr' 
        ? `Merhaba, ${jersey.name} için toptan sipariş hakkında bilgi almak istiyorum. ${quantity} adet sipariş vermek istiyorum. Detaylar için bilgi verebilir misiniz?`
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="font-medium text-gray-900 dark:text-gray-100">
                  {t("quantity")} <span className="text-sm font-normal text-gray-500">(Min: {jersey.minOrder})</span>
                </h3>
                <div className="flex items-center max-w-xs">
                  <div className="mx-4 text-xl font-medium w-16 text-center">{quantity}</div>
                  <Button 
                    variant="outline" 
                    size="icon" 
